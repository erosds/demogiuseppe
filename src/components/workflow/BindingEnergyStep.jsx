  ...
  return (
    <div className="flex-1 flex items-center justify-center overflow-auto p-3 animate-fadeIn">
      <div className="max-w-6xl w-full space-y-3">
        ...
        <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-xl p-2 border border-orange-500/30 shadow-lg mb-2">
        ...
        <div className="relative bg-gradient-to-br from-orange-900/30 to-amber-900/30 backdrop-blur-xl p-4 rounded-2xl border-2 border-orange-400/50 shadow-xl">
        ...
        <div className={`relative bg-gradient-to-br from-orange-900/60 to-amber-900/60 backdrop-blur-2xl p-3 rounded-xl border-2 transition-all duration-500 ${isPredictingBinding ? 'border-orange-400 shadow-lg shadow-orange-500/50 scale-105' : 'border-orange-500/40'} z-20`}>
