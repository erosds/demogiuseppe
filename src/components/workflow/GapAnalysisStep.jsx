  ...
  return (
    <div className="flex-1 flex items-center justify-center overflow-hidden p-2 animate-fadeIn min-h-0">
      <div className="max-w-6xl w-full space-y-3">
        ...
        <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-xl p-3 border border-green-500/30 shadow-lg">
          ...
          {sortedMoleculesForGap.map((mol, idx) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-white text-center font-semibold mt-3 truncate flex-shrink-0 w-full px-1">{mol.name}</p>
